...
const cardContainerDiv = document.getElementsByClassName("cardContainerDiv")[0];
...
const navigateAndSelectProduct = (key) => {
    if(key === "ArrowDown") {
        ...
        if (indexToSelect > 0) {
            if(productContainerToSelect.classList.contains("selected")) {
                deselectProduct();
            }
            else {
                productContainerToSelect.classList.add("selected");
                // productContainerToSelect.style.backgroundColor = "#124BFF";   
...
const selectProduct = (index) => {
    const productToSelect = filteredProduct[index].id.toString();
    const productContainerToSelect = document.getElementById(productToSelect);
    productContainerToSelect.style.backgroundColor = "#124BFF";
    productContainerToSelect.firstChild.style.color = "white";
    return productContainerToSelect;
}
